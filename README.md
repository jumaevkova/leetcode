...
- [LeetCode Problem Set](https://leetcode.com/problemset) – main list of problems
...
- [**Golang**](https://go.dev/doc/) – main language for problem solutions
- [**PostgreSQL**](https://www.postgresql.org/docs/) – used for database-related challenges and practice
